...
Proyecto: Website académico/Tech con dataset de titulares del Blog de
Python
Objetivo: Demonstrar flujo reproducible de extracción y procesamiento de
datos para comunicación digital.
...
2.python src/scrape_python_blog.py
3.python src/process_posts.py
